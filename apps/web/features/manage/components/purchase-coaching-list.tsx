...
interface PurchaseCoachingListProps {
  items: any[];
  hasNextPage?: boolean;
...
export default function PurchaseCoachingList({
  items,
  hasNextPage,
  isFetchingNextPage,
  fetchNextPage,
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {items.length === 0 ? (
        ...
        <div className="mt-6 grid grid-cols-1 gap-9 md:grid-cols-2 lg:grid-cols-3">
