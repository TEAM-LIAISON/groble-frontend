  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="mt-5 flex md:flex-row flex-col items-center gap-3">
        {/* 1 */}
        <div className="rounded-lg border border-dashed border-label-assistive p-4 flex flex-row md:flex-col items-center justify-center w-full md:w-auto">
          <Image
        ...
        <div className="rounded-lg border border-dashed border-label-assistive p-4 flex flex-row md:flex-col items-center justify-center w-full md:w-auto">
          ...
          />
          <div className="flex flex-col items-start md:items-center">
            <p className="mt-1 text-body-1-normal font-bold text-label-normal tracking-[0.00569rem;]">
              고객 관리 기능으로 전환 높이기
            </p>
            <p className="mt-1 text-label-1-normal text-label-neutral leading-5 text-start md:text-center">
              구매자와 잠재 고객을 그룹화하고
        ...
        <div className="rounded-lg border border-dashed border-label-assistive p-4 flex flex-row md:flex-col items-center justify-center w-full md:w-auto">
          ...
          <div className="flex flex-col items-start md:items-center">
            ...
            <p className="mt-1 text-label-1-normal text-label-neutral leading-5 text-start md:text-center tracking-[0.01269rem]">
              판매가 완료되면 설정한 주기에 따라
              <br />
              수익이 자동 정산돼요.
            </p>
