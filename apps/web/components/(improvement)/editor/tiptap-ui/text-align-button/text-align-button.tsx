...
// --- Icons ---
import { AlignCenterIcon } from "@/components/(improvement)/editor/tiptap-icons/align-center-icon";
import { AlignJustifyIcon } from "@/components/(improvement)/editor/tiptap-icons/align-justify-icon";
import { AlignLeftIcon } from "@/components/(improvement)/editor/tiptap-icons/align-left-icon";
import { AlignRightIcon } from "@/components/(improvement)/editor/tiptap-icons/align-right-icon";
