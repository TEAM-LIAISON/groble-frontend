    ...
    <>
      ...
      <div className="w-full flex justify-center h-[calc(100vh-68px)]">
        <div className="flex flex-col items-center max-w-[480px] w-full">
          {/* 완료 메시지 */}
          <div className="flex flex-col items-center mt-[9.06rem]">
            <Image
            ...
            <p className="mt-2 text-body-1-normal text-label-alternative leading-6 tracking-[0.00569em] text-center">
              더 발전된 모습으로 여기 있을게요.
              <br />
              다시 찾아와주세요!
            </p>
