...
export default function WithdrawPage() {
  ...
  const isWithdrawDisabled = !selectedReason;

  return (
    <>
      <WebHeader mobileBack="back" mobileTitle="탈퇴" />
      <div className="w-full flex justify-center h-[calc(100vh-68px)]">
        <div className="flex flex-col max-w-[480px] w-full p-5 md:p-0">
          {/* 헤더 */}
          <div className="md:mt-[9.06rem] ">
            <h1 className="text-heading-1 md:text-title-3 font-semibold md:font-bold text-label-normal mb-[0.13rem]">
              정말로 탈퇴하시겠어요?
            </h1>
                    ...
                    <div className="mt-1 ml-6">
                      <div className="relative">
                        <textarea
                          ...
                          placeholder="상세 사유를 적어주세요 (선택사항)"
                          className="w-full p-4 pb-8 border border-line-normal rounded-lg resize-none focus:outline-none text-body-2-normal"
                          rows={3}
                          maxLength={200}
                        />
